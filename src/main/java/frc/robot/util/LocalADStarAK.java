...
public class LocalADStarAK implements Pathfinder {
     ...
     *
     * @param startPosition
     * Start position on the field. If this is within an obstacle it will be
     ...
     *
     * @param goalPosition
     * Goal position on the field. f this is within an obstacle it will be moved
     ...
     *
     * @param obs
     * A List of Translation2d pairs representing obstacles. Each Translation2d represents
     * opposite corners of a bounding box.
     * @param currentRobotPos
     * The current position of the robot. This is needed to change the start
