...
public class IntakeIOSparkMax implements IntakeIO {
    ...
    public IntakeIOSparkMax(int port) {
        ...
        config.smartCurrentLimit((int)IntakeConstants.kSupplyCurrentLimit);
        config.encoder.positionConversionFactor(1 / IntakeConstants.kGearRatio);

        config.inverted(IntakeConstants.kInvertMotor);
